...
def sidebar():
    ...
    SECTIONS = [
        ...
        {"label": "🎮 PLAY GAMES!", "color": "#f59e0b", "items": [
            ("🔤", "🔤 Secret Message Maker", "🔤 Secret Message Maker"),
            ("🔢", "🔢 Prime Factor Cracker", "🔢 Prime Factor Cracker"),
            ("🧱", "🧱 Quantum Block Drop",   "🧱 Falling Blocks"),
            ("🚩", "🚩 Capture the Flag",     "🚩 CTF Challenge"),
            ("─", "── 🆓 Free to Try ──", "─ Coding Games"),
            ("🛡️", "🛡️ Code the Shield",      "🛡️ Code the Shield"),
            ("🎮", "🎮 Cipher Quest RPG",      "🎮 Cipher Quest"),
            ("─", "── ✨ Premium ──", "─"),
        ...
        {"label": "🔬 SCIENCE LABS!", "color": "#8b5cf6", "items": [
            ("🧪", "🧪 Crypto Lab",             "🧪 Crypto Lab"),
            ("📡", "📡 TLS Simulator",          "📡 TLS Simulator"),
            ("🌡️", "🌡️ Threat Thermometer",    "🌡️ Threat Thermometer"),
            ("⚛️", "⚛️ Live PQC Demo",          "⚛️ PQC Live Demo"),
            ("📺", "📺 Video Explainers",        "📺 Explainers"),
        ]},
        {"label": "👾 MY PROFILE", "color": "#3b82f6", "items": [
            ("📊", "📊 My XP & Progress",      "📊 My Progress"),
            ("🎨", "🎨 My Character",           "🎨 My Character"),
            ("🃏", "🃏 My Trading Cards",       "🃏 Trading Cards"),
            ("📸", "📸 Share My Wins",          "📸 Share Achievement"),
        ]},
        {"label": "🏆 COMMUNITY", "color": "#ec4899", "items": [
            ("🏆", "🏆 Top Players",            "🏆 Leaderboard"),
            ("🏫", "🏫 School Rankings",        "🏫 School Rankings"),
            ("🗺️", "🗺️ Mission Map",            "🗺️ Mission Map"),
            ("🌍", "🌍 World Map",              "🌍 World Map"),
        ]},
        {"label": "📖 LEARN MORE", "color": "#06b6d4", "items": [
            ("🤖", "🤖 Ask the AI Tutor",       "🤖 AI Tutor"),
            ("📖", "📖 Research Journal",        "📖 Research Journal"),
            ("🗺️", "🗺️ Career Explorer",        "🗺️ Career Explorer"),
            ("☠️", "☠️ Quantum Threat Clock",    "☠️ Harvest Timeline"),
            ("📚", "📚 Lesson Plans",            "📚 Lesson Plans"),
            ("💬", "💬 Send Feedback",           "💬 Feedback"),
            ("📧", "📧 Weekly Report",           "📧 Weekly Report"),
        ]},
        {"label": "⚙️ SETTINGS", "color": "#6b7280", "items": [
            ("👨‍🏫", "👨‍🏫 Teacher Dashboard",    "👨‍🏫 Teacher Dashboard"),
            ("💎", "💎 Upgrade My Plan",         "💎 Pricing & Plans"),
        ...
        if not allowed and level not in ["", None]:
            ...
            with col2:
                ...
                st.markdown(
                    ...
                    "School license from $1,999/yr · 7-day free trial · 30-day money-back guarantee</div>",
                    unsafe_allow_html=True
                )
            st.stop()
